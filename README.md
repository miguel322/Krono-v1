...
*   **Gestión Avanzada de Turnos y Calendarios (Shifts & Calendars):** Flujo guiado de 3 etapas (Horarios → Ciclos → Calendarios) cuyo cuadrante (Roster) **se deriva automáticamente** —no se llena a mano—. Clasificación explícita de **horarios FIJOS** (anclados a los días de la semana, permanentes) frente a **ROTATIVOS** (secuencias N-días que avanzan con fase para cobertura). Catálogo de horarios flexibles, nocturnos cruzados y guardias extensas; asignación permanente o temporal por empleado/departamento con sobrescritura automática de solapes.
*   **Publicación Configurable por Calendario:** Horizonte rodante con estados por periodo (En Curso / Publicada / Borrador / Proyectada) para operaciones de rotación anunciada (casinos, retail, seguridad). La **política de publicación es configurable por cada calendario** —cadencia Semanal/Quincenal/Mensual, día de aviso libre y periodos por adelantado—; los horarios fijos quedan como permanentes sin publicación. Al publicar, se **notifica a cada empleado** su horario y el periodo queda bloqueado, con los cambios canalizados como intercambios auditados.
